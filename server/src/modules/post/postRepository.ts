...
class PostRepository {
  ...
  async read(id: number) {
    // Il faut récupérer toutes les informations de l'utilisateur qui a posté le message ainsi que le message lui-même ordonné par date de création de manière décroissante.
